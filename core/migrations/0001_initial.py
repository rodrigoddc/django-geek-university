# Generated by Django 3.0.4 on 2020-03-16 13:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True, verbose_name='Modified')),
                ('active', models.BooleanField(default=True, verbose_name='Active?')),
                ('name', models.CharField(max_length=100, verbose_name='Employee')),
                ('bio', models.TextField(max_length=65, verbose_name='Bio')),
